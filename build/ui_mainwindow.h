...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        AddDeviceButton->setGeometry(QRect(10, 10, 90, 28));
        StartButton = new QPushButton(centralwidget);
        StartButton->setObjectName(QString::fromUtf8("StartButton"));
        StartButton->setGeometry(QRect(120, 10, 100, 28));
        StopButton = new QPushButton(centralwidget);
        StopButton->setObjectName(QString::fromUtf8("StopButton"));
        StopButton->setGeometry(QRect(240, 10, 100, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        AddDeviceButton->setText(QApplication::translate("MainWindow", "Add Device", nullptr));
